                ...
                if (data && data.isSuccess) {
                    ...
                    if (data.list && data.list.length > 0) {
                        ...
                        for (var o in list) {
                            ...
                            html += "<td width='13%'>" + DateFormat.prototype.format(createDate, "yyyy-MM-dd HH:mm:ss") + "</td><td width='10%' class='yellow'>" + status + "</td><td > <a href=\"JavaScript:void(0)\" name='unBindSku' onclick='ItemList.unBindItem("+jdSkuId+")'>解除关联</a></td>";
                            //html += "<td></td>";
                            html += "</tr>";
